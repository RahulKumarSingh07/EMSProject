...
namespace EMSProject.Respository.Service
{
    public class UserService:IUser
    {
        ...
        private  void SendMail(string to,string Otp)
        {
            ...
            mail.To.Add(to);
            mail.From = new MailAddress("Chetu132@gmail.com");
            ...
            smtp.Credentials = new System.Net.NetworkCredential("Chetu132@gmail.com", "Enter youer password"); // Enter seders User name and password  
            smtp.EnableSsl = true;
            smtp.Send(mail);
